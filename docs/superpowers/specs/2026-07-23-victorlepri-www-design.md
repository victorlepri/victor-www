...
3. Projects overlay, two groups with pixel glyph headings:
   ...
   DEVELOPMENT: STOOP NYC, tag "Find your next place, together.", description: "An iOS and browser app for deciding your next home, with your people. Paste a listing, score it solo, then the Reveal shows everyone's take. The best fit wins. Free on the App Store as Stoop NYC." Link: stoopnyc.app.
